...
-- Only update the functions that still have mutable search_path
...
DROP TRIGGER IF EXISTS trigger_toggle_retweet_notification ON retweets;
CREATE TRIGGER trigger_toggle_retweet_notification
